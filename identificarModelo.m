...
%identificar la funciÃ³n de transferencia de 'caja negra' del proceso
funcDesconocida = tf(3.79,[40 1 0],'InputDelay',2+tnegative);

%aplicar escalón a funciÃ³n 'desconocida' y declarar salida 
[salida, tiempo] = step(funcDesconocida,0:0.5:40);

%plotear respuesta escalÃ³n para mÃ©todo de Alfaro
figure()
